        ...
        <div>
          <ul className="overflow-hidden flex gap-[23px]">
            {testimonials.map((testimonial) => (
              <li
                key={testimonial.id}
                className="w-full md:w-[322.72] lg:w-[370] h-[200px] lg:h-[250px] shrink-0 flex flex-col gap-4 lg:gap-6 p-5 lg:px-6 border-s-2 border-secondary rounded-lg lg:rounded-2xl bg-white"
              >
